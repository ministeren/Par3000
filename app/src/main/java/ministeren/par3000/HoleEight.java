...
public class HoleEight extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hole_eight);
        ...
        back.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleEight.this, HoleSeven.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeEight");
            startActivity(i);
        }});
        ...
        home.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleEight.this, MainActivity.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeEight");
            startActivity(i);
        }});
        ...
        next.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleEight.this, HoleNine.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeEight");
            startActivity(i);
        }});
    ...
    public void onClick(View v) {
        if(v == stroke1){score.setText("1");scoreKort[8]="1";}
        if(v == stroke2){score.setText("2");scoreKort[8]="2";}
        if(v == stroke3){score.setText("3");scoreKort[8]="3";}
        if(v == stroke4){score.setText("4");scoreKort[8]="4";}
        if(v == stroke5){score.setText("5");scoreKort[8]="5";}
        if(v == stroke6){score.setText("6");scoreKort[8]="6";}
        if(v == stroke7){score.setText("7");scoreKort[8]="7";}
        if(v == stroke8){score.setText("8");scoreKort[8]="8";}
    }
}
