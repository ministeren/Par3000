...
public class HoleFive extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hole_five);
        ...
        back.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFive.this, HoleFour.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFive");
            startActivity(i);
        }});
        ...
        home.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFive.this, MainActivity.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFive");
            startActivity(i);
        }});
        ...
        next.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFive.this, HoleSix.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFive");
            startActivity(i);
        }});
    ...
    public void onClick(View v) {
        if(v == stroke1){score.setText("1");scoreKort[5]="1";}
        if(v == stroke2){score.setText("2");scoreKort[5]="2";}
        if(v == stroke3){score.setText("3");scoreKort[5]="3";}
        if(v == stroke4){score.setText("4");scoreKort[5]="4";}
        if(v == stroke5){score.setText("5");scoreKort[5]="5";}
        if(v == stroke6){score.setText("6");scoreKort[5]="6";}
        if(v == stroke7){score.setText("7");scoreKort[5]="7";}
        if(v == stroke8){score.setText("8");scoreKort[5]="8";}
    }
}
