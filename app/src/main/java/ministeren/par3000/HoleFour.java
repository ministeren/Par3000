...
public class HoleFour extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            startActivity(new Intent(HoleFour.this, HoleThree.class));
        }});

        home.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            startActivity(new Intent(HoleFour.this, MainActivity.class));
        }});

        next.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            startActivity(new Intent(HoleFour.this, HoleFive.class));
        }});
