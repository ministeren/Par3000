...
public class HoleFour extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hole_four);
        ...
        back.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFour.this, HoleThree.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFour");
            startActivity(i);
        }});
        ...
        home.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFour.this, MainActivity.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFour");
            startActivity(i);
        }});
        ...
        next.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleFour.this, HoleFive.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeFour");
            startActivity(i);
        }});
    ...
    public void onClick(View v) {
        if(v == stroke1){score.setText("1");scoreKort[4]="1";}
        if(v == stroke2){score.setText("2");scoreKort[4]="2";}
        if(v == stroke3){score.setText("3");scoreKort[4]="3";}
        if(v == stroke4){score.setText("4");scoreKort[4]="4";}
        if(v == stroke5){score.setText("5");scoreKort[4]="5";}
        if(v == stroke6){score.setText("6");scoreKort[4]="6";}
        if(v == stroke7){score.setText("7");scoreKort[4]="7";}
        if(v == stroke8){score.setText("8");scoreKort[4]="8";}
    }
}
