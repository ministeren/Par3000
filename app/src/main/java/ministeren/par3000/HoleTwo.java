...
public class HoleTwo extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleTwo.this, HoleOne.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeTwo");
            startActivity(i);
        }});
        ...
        home.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleTwo.this, MainActivity.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeTwo");
            startActivity(i);
        }});
        ...
        next.setOnClickListener(new View.OnClickListener() {public void onClick(View v) {
            ...
            Intent i = new Intent(HoleTwo.this, HoleThree.class);
            i.putExtra("scoreKort",scoreKort);
            i.putExtra("startetAf","holeTwo");
            startActivity(i);
        }});
    ...
    public void onClick(View v) {
        if(v == stroke1){score.setText("1");scoreKort[2]="1";}
        if(v == stroke2){score.setText("2");scoreKort[2]="2";}
        if(v == stroke3){score.setText("3");scoreKort[2]="3";}
        if(v == stroke4){score.setText("4");scoreKort[2]="4";}
        if(v == stroke5){score.setText("5");scoreKort[2]="5";}
        if(v == stroke6){score.setText("6");scoreKort[2]="6";}
        if(v == stroke7){score.setText("7");scoreKort[2]="7";}
        if(v == stroke8){score.setText("8");scoreKort[2]="8";}
    }
}
